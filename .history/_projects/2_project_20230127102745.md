...
[Repository](https://github.com/josemanuel22/BirthDeathProcess.jl) BirthDeathProcess process is a package in julia that implements a series of utilities to simulate the Birth-Death process, given by the differential equation $$ n' = \beta - d\cdot n $$.

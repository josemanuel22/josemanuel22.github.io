...
- The symmetric positive definite matrix $$M$$ must be chosen s.t. the new system is solved with less computational work than the original one. That means that $$M^{-1}A$$ has a more 'favourable' conditional number than simply $$A$$.